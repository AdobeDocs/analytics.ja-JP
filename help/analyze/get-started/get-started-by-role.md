...
| Analytics のセグメント化 | Adobe AnalyticsやAdobe CX Enterprise、Adobe Targetなどの統合されたAdobe製品を利用して、レポートを作成、管理、共有し、強力なオーディエンスセグメントを適用できます。 | [Analytics のセグメント化](/help/components/segmentation/seg-home.md) |
