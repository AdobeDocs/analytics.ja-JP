...
2. 次の製品の機能のいずれかを選択して設定します。
   ...
   | 計算指標 | 計算指標および高度な計算（または派生）指標は、既存の指標から作成できるカスタム指標です。これにより、マーケター、製品マネージャーおよびアナリストは、Adobe Analytics の実装を変更することなく、データについて質問できるようになります。 | [計算指標および高度な計算指標](https://experienceleague.adobe.com/docs/analytics/components/calculated-metrics/cm-overview.html?lang=ja) |
   ...
   | アラート | アラート機能では、アラートをよりきめ細かく制御できるほか、異常値検出とアラートシステムを統合できます。 | [アラートの概要](https://experienceleague.adobe.com/docs/analytics/components/alerts/intellligent-alerts.html?lang=ja) |
...
2. 次の製品の機能のいずれかを選択して設定します。
   ...
   | Report Builder | Adobe Report Builder は Microsoft Excel のアドインです。Adobe Analytics データ（Excel ワークシートに挿入可能）からカスタムリクエストを作成できます。リクエストはセルから動的に参照できます。さらに、Report Builder によるデータの表示形式は更新やカスタマイズが可能です。 | [Report Builder とは](https://experienceleague.adobe.com/ja/docs/analytics/analyze/report-builder/rb-overview) |
