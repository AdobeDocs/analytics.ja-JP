...
顧客属性のアップロード方法について詳しくは、[CX Enterprise ヘルプ &#x200B;](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/attributes.html?lang=ja)を参照してください。

* 指標として設定されている場合、VisAttrは指標と「ディメンション」の両方として公開されます。

  指標とディメンションの顧客属性を示す![&#x200B; スクリーンショット。](assets/ca_metrics.png) ![](assets/ca_dimension.png)

* eVar と同様の分類（クロス集計）が可能です（どの項目も任意の項目で分類できます）。
* VisAttrはすべてのeVar指標をサポートしています。
