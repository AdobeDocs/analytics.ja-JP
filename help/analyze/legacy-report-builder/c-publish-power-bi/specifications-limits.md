---
description: Report Builder と Microsoft Power BI を使用する際のレポートの制限事項
title: 制限および仕様
...
## Power BI の公開に関する制限事項 {#section_D4BDD70B20F94A0FAE53531CA528AE42}

>[!NOTE]
>
>以下の制限事項は、「Report Builder リクエストを Power BI データセットテーブルとして公開」オプションのみに適用されます。
...
## Power BI に公開した後の Report Builder リクエストの編集 {#section_6989E74F68DD43F08D37C36B6777DB50}

>[!NOTE]
>
>この仕様は、「すべての Report Builder リクエストを Power BI データセットテーブルとして公開」と「ブック内のすべての書式設定済みテーブルを Power BI データセットテーブルとして公開」というオプションに適用されます。
...
## Power BI レポート名の変更 {#section_2E7893A78B914EBFACB2B08CBD9E472E}
