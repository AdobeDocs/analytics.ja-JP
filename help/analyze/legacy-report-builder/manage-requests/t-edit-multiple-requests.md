...
レポートスイート、精度、日付範囲に基づいて、同時に複数のリクエストを変更できます。

レポートスイート、セグメント、精度、日付範囲に基づいて、同時に複数のリクエストを変更できます。 例えば、すべてのリクエストが同じレポートスイートまたはセグメントに基づくようにレポートのパラメーターを更新したり、同じ期間を保持している場合に限り、日次レポートを週次または月次レポートに変換したりできます。 現在のワークシートまたはスプレッドシートのすべてのワークシートに対して、複数のリクエストを編集できます。
...
1. リクエストの表示をグループ化するには、次のいずれかのオプションをクリックします。
   ...
   * **セグメント別**: セグメント名に基づいてリクエストをグループ化します。
     ...
     * **セグメントを選択**：リクエストにセグメントが存在しないかどうかを表示します。 セグメントを追加するには、**[!UICONTROL グループを編集]**&#x200B;をクリックし、[!UICONTROL &#x200B; グループを編集] パネルからセグメントを選択します。
