...
| **[!UICONTROL 新規作成]**&#x200B;モーダルが復活しました | ワークスペースで「**[!UICONTROL 新規作成]**」をクリックする際は、「[!UICONTROL 空のプロジェクト]」および「[!UICONTROL 空のモバイルスコアカード]」のどちらかを選択することになります。会社が作成した任意のテンプレートから選択することもできます。 | ![新規作成](assets/create-new.png) |
