...
| --- | --- |
| トレーニングチュートリアル | 最頻使用/トレーニングチュートリアル |
| Web コンテンツ消費 | アクション/Web コンテンツ消費 |
| メディアコンテンツ消費 | エンゲージメント/メディアコンテンツ消費 |
| クロスファイル分析 | エンゲージメント/デバイス間分析 |
| Web 保持 | アクション/ Web リテンション |
| メディアオーディオ消費 | エンゲージメント/メディアオーディオ消費 |
| メディア最新性、頻度、ロイヤルティ | エンゲージメント/メディア最新性、頻度、ロイヤリティ |
| ITP の影響 | エンゲージメント/ITP 影響 |
| 製品のパフォーマンス | コンバージョン/製品/製品のパフォーマンス |
| Magento:マーケティングとコマース | コンバージョン/Magento:マーケティングとコマース |
| 人物指標 | オーディエンス/人物指標 |
| ロケーションの概要 | オーディエンス/訪問者プロファイル/ロケーションの概要 |
| 技術概要 | オーディエンス/訪問者プロファイル/技術/技術概要 |
| モバイルアプリの使用状況 | オーディエンス/モバイル/モバイルアプリの使用状況 |
| モバイルアプリジャーニー | オーディエンス/モバイル/モバイルアプリのジャーニー |
| モバイルアプリ指標 | オーディエンス/モバイル/モバイルアプリメッセージ |
| モバイルアプリのパフォーマンス | オーディエンス/モバイル/モバイルアプリのパフォーマンス |
| モバイルアプリの定着 | オーディエンス/モバイル/モバイルアプリの保持率 |
...
カスタムレポートは会社レポートと呼ばれ、会社レポートメニューに表示されます（以下を参照）。 以前に作成したものと新しいものがここに表示されます。

新しい会社レポートを作成するには、次の手順に従います。

1. 目的の状態にワークスペースを作成します。
1. [!UICONTROL  プロジェクト ] メニューを開き、**[!UICONTROL 会社レポートとして保存…]** をクリックします。

   ![会社レポート](assets/company-report.png)

1. 必要なフィールドをすべてモーダルに追加して保存します。

   レポートは会社レポートリストに追加され、ログイン会社のレポートで使用できます。
