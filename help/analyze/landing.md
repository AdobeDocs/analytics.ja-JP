...
[!UICONTROL プロジェクト]は、 [!UICONTROL ワークスペース] ホームページとして機能します。「プロジェクト」タブには、会社フォルダ、作成した個人用フォルダ、プロジェクト、モバイルスコアカードが表示されます。 このページを使用して、フォルダ、プロジェクト、モバイルスコアカードを表示、作成、変更します。 詳しくは、 [Analytics のフォルダーについて](/help/analyze/analysis-workspace/build-workspace-project/workspace-folders/about-folders.md).
...
| UI 要素 | 定義 |
| --- | --- |
| 環境設定を編集 | [!UICONTROL チュートリアルを表示]し、[ユーザーの環境設定を編集](/help/analyze/analysis-workspace/user-preferences.md)できます。 |
...
| テーブルアイコンのカスタマイズ | 表に表示する列を選択します。 プロジェクトのリストに列を追加または削除するには、列アイコン (![すべてランディング](/help/analyze/assets/select-column.png) ) を右上に表示し、列タイトルを選択または選択解除します。 |
| 表示：フォルダーとプロジェクトまたはすべてのプロジェクト | テーブルの表示設定を変更して、フォルダ組織に応じたフォルダやプロジェクトを表示します **または** すべてのプロジェクトを非整理リストで表示します。 |
| &lt;（戻るボタン） | Workspace プロジェクトまたはレポート内の最新のランディングページ設定に戻ります。 ランディングページを離れたときのページ設定は、戻ったときに保持されます。 |
...
プロジェクトマネージャーページの一般的な使用例の 1 つは、すべてのプロジェクトを表示することです。

フィルターレールを使用して新しいランディングページのすべてのプロジェクトを表示するには、「 」を選択します **その他のフィルター** 次に、 **すべて表示**.
...
管理者が使用するもう 1 つの使用例は、レポートの削除、名前変更、タグ付け、承認をおこなうための会社レポートの管理です。 レポートの管理について詳しくは、 [会社レポートの管理](#manage-company-reports).
...
ログイン会社の他のユーザーが使用するために作成および保存したカスタムレポートは、会社レポートと呼ばれます。 以前に作成した会社レポートと新しく作成した会社レポートは、次に示すように、「プロジェクトを作成」モーダルに表示されます。
...
管理者は、プロジェクトリストをフィルタリングして、会社レポートを表示および管理できます。 固定された項目は、その後に ![レポートアイコン](assets/report-icon.png) レポートアイコン。 このビューでは、1 つ以上のレポートの削除、名前の変更、タグ付け、承認を行うことができます。

会社レポートを表示および管理するには

1. フィルターレールで、「 」を選択します。 **その他のフィルター** 次に、 **会社レポート**.
会社レポートのリストが表示されます。 ピン留めされていない限り、すべての通常のプロジェクトは表示されません。

   ![会社レポートフィルターを表示](assets/company-reports-filter.png)

   会社レポートが表示された状態で、管理者は、レポートの削除、名前の変更、タグの追加、承認をおこなうことができます。

1. レポートリストで、1 つのレポートを選択するか、複数のレポートを選択します。

1. 次をクリック： **...** レポートの横にある省略形のアイコンを使用して、使用可能なオプション（削除、名前変更、タグ、承認）を表示します。

   ![会社レポートのアクション](assets/company-reports-actions.png)

1. オプションを選択します（削除、名前変更、タグ、承認）。

1. 完了したら通常のビューに戻るには、フィルターレールで、「会社レポート」オプションのチェックを再度オフにします。

### 会社レポートの削除

管理者は、上記の会社レポートリストオプションを使用してレポートを削除したり、プロジェクト作成モーダルからレポートを削除したりできます。
