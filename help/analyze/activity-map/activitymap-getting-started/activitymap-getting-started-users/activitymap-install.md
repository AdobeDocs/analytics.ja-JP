...
* この機能をサポー **[!UICONTROL Remember my login]** トします。
...
1. クリック **[!UICONTROL Download Activity Map]**.
1. クリック **[!UICONTROL Install the Activity Map Plug-in]**.
...
1. クリック **[!UICONTROL Install Now]**.
1. 右上のアイ **[!UICONTROL Open Menu]** コンをクリックし、を選択しま **[!UICONTROL Add-Ons]**&#x200B;す。 ![](assets/firefox_install3.png){width=&quot;250px&quot;}
