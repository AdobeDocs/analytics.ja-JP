...
1. **[!UICONTROL Analytics]**／**[!UICONTROL 管理者]**／**[!UICONTROL コードマネージャー]**&#x200B;に移動して、最新の AppMeasurement コード（AppMeasurement_Javascript-1.6.zip）をダウンロードし、[実装します](https://marketing.adobe.com/resources/help/en_US/sc/implement/js_implementation.html)。
...
1. [このグループにユーザーを追加](https://marketing.adobe.com/resources/help/en_US/reference/groups.html)して「**[!UICONTROL グループの保存]**」をクリックします。
