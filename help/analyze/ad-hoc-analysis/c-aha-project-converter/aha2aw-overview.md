---
description: Ad Hoc Analysis プロジェクトコンバーターの概要
...
Ad Hoc Analysisプロジェクトコンバータは、Ad Hoc Analysisプロジェクトを[Analysis Workspace](https://docs.adobe.com/content/help/ja-JP/analytics/analyze/analysis-workspace/home.html)にシームレスに変換します。 プロジェクトは一度に1つずつ、または一括で変換できます。
