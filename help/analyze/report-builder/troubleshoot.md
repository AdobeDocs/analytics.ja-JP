...
seo-title: Report Builder のトラブルシューティングとベストプラクティス
solution: Analytics
...
* ワークブックを開くと、次の警告が表示されます。「このワークブックは、Report Builder v5.1を使用して最後に保存されました。このバージョンでは、このコンピューターにインストールされているReport Builderバージョンと互換性のない機能が導入されています。 このワークブックを更新する前に、Report Builderの最新バージョンにアップグレードすることを強くお勧めします。」
...
* [!DNL Analytics]:お気に入 **[!UICONTROL り]** /予定 **[!UICONTROL レポート]**
...
> [!NOTE] これはエラーメッセージの選択に過ぎず、完全なリストではありません。 エラーの解決法について詳しくは、管理者にお問い合わせください。
