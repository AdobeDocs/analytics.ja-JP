...
* **データブロックのグループを含むワークシートをコピーします**。 複数のデータ・ブロックを含むワークシートのコピーをサポートする手順は、次のとおりです：
   ...
   1. コピー先のワークシートで、次の操作を行います。
      ...
      1. ![4&rbrace;Report Builder ハブ &#x200B;](/help/assets/icons/Paste.svg) から「**[!UICONTROL 貼り付け]**」 [&#x200B; データブロックの貼り付け &rbrace; を選択します。](/help/analyze/report-builder/report-builder-hub.md)
