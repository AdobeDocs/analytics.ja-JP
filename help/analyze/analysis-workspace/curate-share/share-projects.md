...
受信者にロールが割り当てられていない場合は(**[!UICONTROL 共有]/プロジェクトリンクを[!UICONTROL 取得]**)、デフォルトで **[!UICONTROL 缶重複]** ロールに配置されます。
...
プロジェクトへのリンクは、 **[!UICONTROL 共有]/プロジェクトのリンク[!UICONTROL の取得で取得できます]**。 クリックすると、受信者はプロジェクトにランディングする前にログインする必要があります。 受信者がプロジェクトロールに配置されていない場合は、デフォルトで **[!UICONTROL 缶重複]** プロジェクトのエクスペリエンスが提供されます。
...
| 受信者がプロジェクトのリンクを開いた場合、ユーザーはどのようなエクスペリエンスを得られますか。 | 受信者にロールが割り当てられていない場合は(**[!UICONTROL 共有]/プロジェクトリンクを[!UICONTROL 取得]**)、デフォルトで **[!UICONTROL 缶重複]** ロールに配置されます。 |
