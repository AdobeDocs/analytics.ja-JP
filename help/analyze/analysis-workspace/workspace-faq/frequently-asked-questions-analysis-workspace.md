...
| ユーザー | Analyticsの「ワークスペース」タブへのアクセスを有効にするには、管理者は、製品プロファイルを分析ワークスペースへのアクセス権限で作成し、 [管理コンソールでそのユーザーを追加する必要があります](/help/admin/admin-console/permissions/product-profile.md)。 |
