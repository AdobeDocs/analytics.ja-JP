...
See ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Calendar and date ranges overview](https://video.tv.adobe.com/v/328257?captions=jpn&quality=12&learn=on){target="_blank"} for a demo video.
