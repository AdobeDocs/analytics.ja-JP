...
See ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Date comparison](https://video.tv.adobe.com/v/34732?quality=12&learn=on&captions=jpn){target="_blank"} for a demo video.
