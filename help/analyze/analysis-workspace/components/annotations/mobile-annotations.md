...
注釈アイコンが表示されている場合、ビルダーキャンバスで注釈を完全に表示したり操作したりすることはできません。プレビューモードを使用して、アプリ ![](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Play_18_N.svg) ージに表示される注釈を表示し、操作します **プレビュー**。
