...
上位ファネル分析では、ブランドや製品の認知を高めるために使用されるチャネルを対象とします。 例えば、ほとんどのテレビ広告の目標はブランド認知度の向上です。 テレビ広告は時間の経過とともに忘れられるので、[時間減衰アトリビューションモデル ](/help/analyze/analysis-workspace/attribution/models.md)を使用することができます。
