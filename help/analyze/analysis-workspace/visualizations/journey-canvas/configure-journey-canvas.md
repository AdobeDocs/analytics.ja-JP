...
ノードを選択し、ジャーニー内でノードの直後にある上位の即時または最終的なディメンション項目を表示できます。 上位 3 つのディメンション項目を個別のノードとしてジャーニーキャンバスに追加したり、上位のすべてのディメンション項目をフリーフォームテーブルで表示したりできます。
...
ノードを選択し、ジャーニーの直前に来る上位の即時または最終的なディメンション項目を表示できます。 上位 3 つのディメンション項目を個別のノードとしてジャーニーキャンバスに追加したり、上位のすべてのディメンション項目をフリーフォームテーブルで表示したりできます。
...
* キャンバスで、結合するノードを選択し、選択したノードの1つを右クリックして、**ノードを結合**&#x200B;を選択します。 組み合わせる数に制限はありますか？
