...
![ブレットグラフビジュアライゼーション](assets/bullet.png)
...
デモビデオについて詳しくは、![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [ブレットグラフビジュアライゼーション](https://video.tv.adobe.com/v/23989/?quality=12/?quality=12){target="_blank"}を参照してください。
...
[!UICONTROL ブレット]ビジュアライゼーショの特定の設定を定義できます。

| 設定 | 説明 |
|---|---|
| **[!UICONTROL ブレットオプション]** | [!UICONTROL ブレット]ビジュアライゼーションで、「**[!UICONTROL 目標 - 高]**」、「**[!UICONTROL 目標 - 中]**」、「**[!UICONTROL 目標 - 低]**」の値を指定します。「<br/>**[!UICONTROL 目標 - 高&#x200B;]**」は、目指している主な目標です。「**[!UICONTROL &#x200B;目標 - 低&#x200B;]**」と「**[!UICONTROL &#x200B;目標 - 中&#x200B;]**」では、「目標 - 高」を下回る範囲を作成します。メモ：「**[!UICONTROL &#x200B;割合&#x200B;]**」オプションが選択されている場合は、目標を整数で入力します。目標が 20％の場合は `20` となります。 |
