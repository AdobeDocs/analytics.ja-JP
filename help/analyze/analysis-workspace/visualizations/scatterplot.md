...
>[!NOTE]
>
>散布図で表示するように凡例を[設定すると、](/help/analyze/analysis-workspace/visualizations/freeform-analysis-visualizations.md#settings)は、データソースに限られた数の（選択した）ディメンション項目が含まれている場合にのみ表示されます。
