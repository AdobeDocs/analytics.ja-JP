...
>title="コホートテーブル"
>abstract="イベントの完了にもとづいてユーザーをグループ化し、継続的なエンゲージメントと解約を経時的に分析します。<br/><br/>**パラメーター&#x200B;**<br/>**包含基準**：最初の訪問者コホートを定義するために使用するコンポーネント。<br/>**再来訪条件**：訪問者が再来訪したかどうかを判断するために使用するコンポーネント。"
