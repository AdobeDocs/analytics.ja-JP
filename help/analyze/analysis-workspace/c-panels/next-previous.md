...
>title="次または前の項目"
>abstract="訪問者が来訪前にいた場所、または次に移動する場所として最も一般的なものを分析します。<br/><br/>**ディメンション**：ディメンションを選択します。 （例：**ページ**）<br/>**ディメンション項目**：特定のディメンション項目を選択します。 （例：**ホームページ**）<br/>**方向**：選択したディメンション項目の直後のディメンション項目を確認するには、「**次へ**」を選択します。 選択したディメンション項目に至るディメンション項目を確認するには、「**前へ**」を選択します。<br/>**コンテナ**：「**セッション**」を選択して同じセッション内の次／前のディメンション項目を表示するか、「**ユーザー**」を選択して同じユーザーの次／前のディメンション項目を表示します。"
