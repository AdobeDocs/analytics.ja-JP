...
| [ページの概要](page-summary.md) | 特定のページに関する主な統計を調べます。 |
...
プロジェクト内では、分析のユースケースに応じて、1 つまたは[複数のレポートスイート](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/multiple-report-suites.html?lang=ja)を使用できます。
