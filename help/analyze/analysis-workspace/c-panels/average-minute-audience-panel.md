...
* 選択期間全体の合計分平均オーディエンス
* 個々のビデオに対するフィルターおよび分平均オーディエンス（テーブルに表示）
