...
>title="メディア同時視聴者数"
>abstract="パネルを作成して、特定のコンテンツまたは特定の期間における1分あたりの平均オーディエンス数を分析します。"
...
_この記事では、この記事の_ ![CustomerJourneyAnalytics](/help/assets/icons/CustomerJourneyAnalytics.svg) _&#x200B;**Customer Journey Analytics**&#x200B;版の[&#x200B; メディア同時視聴者数パネル &#x200B;](/help/analyze/analysis-workspace/c-panels/media-concurrent-viewers.md)を参照してください。_![Adobe Analytics](/help/assets/icons/AdobeAnalytics.svg)_&#x200B;**Adobe Analytics Analytics**。_<br/>_ メディア同時視聴者数パネル _を参照してください。
...
>[!NOTE]
>
>メディアの分平均オーディエンスパネルは、Adobe Analytics for Streaming Media アドオンを購入した顧客のみが使用できます。
>
...
1. Adobe Analytics for Streaming Media アドオンから設定されたコンポーネントを含むパネルのレポートスイートを選択していることを確認します。
...
>[!VIDEO](https://experienceleague.adobe.com/ja/docs/analytics-learn/tutorials/analysis-workspace/using-panels/media-concurrent-viewers-panel-in-analysis-workspace)
