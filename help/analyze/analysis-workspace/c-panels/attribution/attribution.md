...
> [!NOTE] 次のアルゴリズムアトリビューションモデルは、現在 [Adobe Analytics Labsで使用可能で](https://docs.adobe.com/content/help/en/analytics/analyze/tech-previews/overview.html) 、2020年の一般リリースの一部となります。
