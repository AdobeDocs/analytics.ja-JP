...
> [!NOTE] 次のアルゴリズムアトリビューションモデルは、現在 [Adobe Analytics Labsで使用可能で](https://docs.adobe.com/content/help/en/analytics/analyze/tech-previews/overview.html) 、最終的には一般リリースの一部となります。
