...
Analysis Workspaceの事前定義済みレポートを使用すると、最も一般的なレポートシナリオに関するすばやいインサイトを得ることができます。 事前に作成されたレポートを使用して回答できる質問の例を次に示します。
...
次の情報では、 [!UICONTROL レポート] Analysis Workspaceの「 」タブに移動します。

## レポートへのアクセスと実行

1. Analysis Workspaceで、 [!UICONTROL **Workspace**] タブをクリックします。
...
1. 検索フィールドに、検索するレポートの名前を入力し、レポートのリストから選択します。 レポートリストを prop、eVar、イベント番号でも検索できるようになりました。<!-- still true? -->
   ...
   >[!TIP]
   >
   >   矢印キーを使用してメニューを移動するには、スラッシュ (/) キーを押し、下矢印キーを押します。 [Enter] を押して、選択したレポートを読み込みます。
