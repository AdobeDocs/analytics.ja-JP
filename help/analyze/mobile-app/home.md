...
>[!IMPORTANT]
>
>Adobe Analyticsダッシュボードはリリースされておらず、招待ユーザーの間でのベータテストのみに使用できます。 このドキュメントはベータ版ユーザーのみを対象としており、機能の完全な機能を示すものではありません。この機能のベータ版のご利用を希望される場合は、Ashok Gorrepati(gorrepat@adobe.com)にお問い合わせください。
