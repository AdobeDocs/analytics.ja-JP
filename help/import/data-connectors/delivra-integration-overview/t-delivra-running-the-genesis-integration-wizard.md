...
1. Data **Connectors** UIの左側にある **パートナーリスト** の上部にある「アルファベット順»タブをクリックして?、«リファラー?****
1. **Deivra** アイコンをAnalyticsレポートスイートの空のプラグインスロットにドラッグして、Data Connectors統合ウィザードを起動します。
1. Excivra統合の紹介ページで、テキストを確認し、このチェックボックスを選択して統合に関連する料金を承認し、「 **次へ**」をクリックします。
...
<table id="table_74EC1EEBE7A548AB878AA40187EBCD30"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col3"> <p>DeivraアカウントID（Derovraによって会社に割り当てられた一意の識別子）を指定し、「 <b>次へ」</b> をクリックしてウィザードの手順3に進みます。 </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col3"> <p>ソーシャルネットワークに電子メールメッセージが共有された回数を指定し、「 <b>次へ」</b> をクリックしてウィザードの手順6に進みます。 </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col3"> <p>「 <b>Finish"</b> をクリックして統合を完了します。 </p> <p><b>重要:</b> Analyticsでは、「完了」をクリック <b>するまで統合設定は保存されません</b>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
