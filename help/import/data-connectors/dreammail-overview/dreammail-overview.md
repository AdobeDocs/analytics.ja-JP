...
このマーケティング効率の向上は、[!DNL Analytics] と [!DNL ~Partner~] の統合による主なメリットの 1 つです。さらに、この統合により、クローズドループレポート用として、電子メール指標と [!DNL Analytics] データが 1 時間ごとに自動で同期されます。
...
この統合に関連し、定期的な料金や実装料金が発生する場合があります。価格の詳細については、[!DNL DreamMail] にお問い合わせください。
