...
1. 次のフィールドを設定します。
   ...
   1. **[!UICONTROL Kampyleキー]**: このキーは、Kampyleアプリケーションの「 **[!UICONTROL Feedback Form]** 」の「 **[!UICONTROL Feedback Form Customization]**」で確認できます。
   1. **[!UICONTROL トラッキングサーバー]**: アドビのAnalyticsデータの追跡に使用するトラッキングサーバーの値。
...
>[!NOTE]
>
>Adobe Experience Platform起動を使用する場合は、このツールを使用して統合設定オブジェクトを簡単に追加できます。
...
1. 次のいずれかの方法を使用してコードをデプロイします。
   ...
   * Adobe Experience Platform起動を使用します。
   * アドビのAnalytics展開を維持する組織のリソースにコードを配信します。
