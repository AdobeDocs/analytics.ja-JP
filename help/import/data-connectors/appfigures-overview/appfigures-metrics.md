---
description: appFigures統合の一部として次の指標が同期されます。
seo-description: appFigures統合の一部として次の指標が同期されます。
seo-title: 指標およびディメンション
title: 指標およびディメンション
...
appFigures統合の一部として次の指標が同期されます。

| 指標 | 説明 |
|---|---|
| App Store でのダウンロード数 | モバイルアプリケーションダウンロード数。 |
| App Store購入（アプリ内） | アプリ内課金の数。 |
...
| App Store売上高（アプリ内） | アプリ内での売上金額。 |
| App Store売上高（オフ） | アプリの購入に関連付けられた売上金額。 |
| App Storeロイヤルティ（アプリ内） | 非推奨です。 |
| App Storeロイヤルティ（オフ） | 非推奨です。 |

次の予約済み分類ディメンションは、appFiguresオブジェクトID予約eVar用のdata connectorsウィザードによって作成されます。

| 分類ディメンション | 説明 |
|---|---|
| 国名 | アプリストアのアクティビティに関連する国の名前。 |
| デバイス名 | アプリケーションストアアクティビティに関連するモバイルデバイスの名前。 |
| Appstore名 | アクティビティを報告したappstoreの名前。 |
| アプリ名 | モバイルアプリケーションの名前。 |
| アプリ内名 | アプリケーション内で購入した品目。 |
...
data connectorsウィザードによって次の計算指標が作成されます。

<table id="table_504271ED1A954CCAA234738B07EDDF27"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> 計算指標 </th> 
   <th colname="col2" class="entry"> 説明 </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> App Store平均ランク（数値） </td> 
   <td colname="col2"> <p>アプリの平均ランキング。この計算指標は、次の式を使用して定義されます。 </p> <code> [アプリ&amp; amp;nbsp;保存およびamp;nbsp;ランク（&amp; amp）;nbsp;/amp;nbsp;[アプリ&amp; amp;nbsp;保存およびamp;nbsp;ランク（&amp; amp）;nbsp;約数] </code> <p>注意:カテゴリごとにランク付けされたアプリケーションの数は、アプリストア間で異なります。アプリケーションがこのしきい値より低い場合、アプリケーションのランクは使用できません。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> アプリストア評価平均 </td> 
   <td colname="col2"> アプリの平均レーティング。この計算指標は、次の数式を使用して定義します。 <code> [アプリ&amp; amp;nbsp;保存およびamp;nbsp;レーティング（&amp; amp）;nbsp;/amp;nbsp;[アプリ&amp; amp;nbsp;保存およびamp;nbsp;評価amp（&amp; amp）;nbsp;約数] </code> </td> 
  </tr> 
 </tbody> 
</table>

## 各appFigures指標に関連するディメンション {#section-cd356d3dce04412893beed345305c247}

次の表に、どのレポートディメンションがどの指標に関連しているかを示します。

<table id="table_B9CF57EABE22449FBF1963E3F105E702"> 
 <tbody> 
  <tr> 
   <td> </td> 
   <td> App Store Downlides </td> 
   <td> App Store購入（アプリ内） </td> 
   <td> App Store ランク </td> 
   <td> App Store Rank Divisor </td> 
   <td> App Store 評価 </td> 
   <td> App Store 評価の基準値 </td> 
   <td> App Store売上高（アプリ内） </td> 
   <td colname="col9"> App Store売上高（1回限り） </td> 
   <td colname="col10"> App Store 平均ランク </td> 
   <td colname="col11"> App Store 平均評価 </td> 
  </tr> 
  <tr> 
   <td> 国名 </td> 
