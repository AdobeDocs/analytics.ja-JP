...
1. 次の項目を設定します。
   ...
   | 説明 | （オプション）この統合設定の説明。 |
   | コミュニティID | このIDは、動的シグナル担当者から取得できます。 |
...
1. チェックボックスをオンにすると、動的シグナル統合ダッシュボードを作成できます（オプションで、推奨）。
1. すべての設定項目を確認し、「今すぐアクティブ化」をクリック ****&#x200B;します。
1. **重要**:ウィザードを完了したら、VoiceStormプラットフォームで統合をアクティブにできるように、Dynamic Signal担当者に通知する必要があります。
