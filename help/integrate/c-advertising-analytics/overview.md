...
| 権限 | 定義 | Adobe CX Enterpriseにログインしている場合は、権限を付与します |
| --- | --- | --- |
...
| **[!UICONTROL 一致タイプ （AMO ID）]** | キーワードに割り当てられたキーワードマッチタイプ。 広告タイプに一致するタイプがない場合、通常、値はbroad、phrase、exact、またはnoのいずれかになります。 |
