...
>[!NOTE]
>
>Adobe Analyticsでユーザーに役割を割り当てる前に、CX Enterpriseで最初の管理者としてユーザーを割り当てる必要があります。 最初の管理者は、次に、この記事に記載されているように、組織のユーザーを他の主要な役割でプロビジョニングできます。 最初の管理者について詳しくは、[Adobe Analytics 最初の管理者ガイド](/help/admin/admin-console/first-admin-guide.md)を参照してください。


## CX EnterpriseとAdobe Analyticsの主な役割
...
* **製品管理者：**&#x200B;製品管理者は、Admin Consoleで製品と、その製品に対するユーザーエンタイトルメントを管理します。
* **製品プロファイル管理者：**&#x200B;これらのユーザーは、製品プロファイルにユーザーを追加／削除したり、製品プロファイルの権限項目を調整したり、ユーザーグループに製品プロファイルを割り当てる／削除することができます。 製品プロファイル管理者は、Adobe Analytics に対するフルアクセス権を持っていません。 ただし、チームに対する Adobe Analytics へのアクセスを付与および管理する必要があるチームリーダーやマネージャーに最適です。 製品プロファイルについて詳しくは、[Adobe Analytics の製品プロファイル](/help/admin/admin-console/permissions/product-profile.md)を参照してください。
* **管理者をサポート**: サポートされているユーザーとも呼ばれ、Analytics インターフェイスに追加の権限はありません。 その代わり、Adobe カスタマーケアとのやり取りの際に追加の権限が付与されます。 これらのユーザーは、ほとんどの場合は Analytics の管理者でもあり、カスタマーケアが問題のトラブルシューティングに役立ちます。 エンドユーザーと Adobe カスタマーケアとの間のやり取りを担当する Analytics 管理者を少なくとも 1 人特定します。
* **Web サイトの所有者：**&#x200B;これらの個人またはチームは、Web サイトのコーディングと開発を担当します。 アカウントは不要ですが、データ収集の管理者と連携してタグコードを取得し、web サイトに実装する必要があります。
...
1. Analytics へのフルアクセス権を付与するメールアドレスを入力し、新しく作成したフル管理者アクセスプロファイルを割り当てます。 「**[!UICONTROL 保存]**」をクリックします。

これで、ユーザーは Adobe Analytics へのフルアクセス権を持ちます。

## Experience Platform のデータ収集の製品管理者アクセス権の付与
...
1. これで、ユーザーには Adobe Experience Platform Data Collection へのフルアクセス権が付与されます。
...
Adobe Analyticsでユーザーに役割を割り当てる前に、CX Enterpriseで最初の管理者としてユーザーを割り当てる必要があります。 最初の管理者は、次に、この記事に記載されているように、組織のユーザーを他の主要な役割でプロビジョニングできます。

1人目の管理者は、組織全体で各CX エンタープライズソリューションを利用できるようにするための出発点となります。
