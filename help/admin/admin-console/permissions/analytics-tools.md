...
|----|----|
| [!UICONTROL Activity Map] | ツール／Activity Map へのアクセスを許可します。また、はユーザーがActivity Map拡張機能を使用できるようにします。 |
...
| [!UICONTROL コードマネージャー] | 管理者/すべての管理者/Code Manager へのアクセス権を付与します。 |
...
| [!UICONTROL &#x200B; 任意のユーザーとプロジェクトリンクを共有 &#x200B;] | Adobe Analyticsへのアクセス権を持たないユーザーに、Analysis Workspace プロジェクトへの読み取り専用アクセス権を付与する機能を付与します。 |
...
| [!UICONTROL Workspace プロジェクト アクセス &#x200B;] | Analysis Workspace へのアクセスを許可します。**この権限項目は、Adobe Analyticsを使用するために必要です。** |
