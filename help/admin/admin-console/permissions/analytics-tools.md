...
| [!UICONTROL レポートスイートを非表示] | 管理者／全ての管理者／会社設定／レポートスイートを非表示へのアクセスを付与します。 レポートスイートへのアクセス権に関係なく、組織内の任意のレポートスイートを非表示にする機能を付与します。 |
| [!UICONTROL 統合 (作成)] | 未使用 |
| [!UICONTROL 統合（更新）] | 未使用 |
| [!UICONTROL 統合（削除）] | 未使用 |
| [!UICONTROL ラボのアクセス] | ユーザーにラボとラボ内のプロトタイプへのアクセスを提供します。 |
| [!UICONTROL レガシー Report Builder] | Microsoft Excelで従来のReport Builder アドオンを使用して認証できるようにします。 |
| [!UICONTROL ログ] | 管理者／全ての管理者／ログへのアクセス権を付与します。 |
...
| [!UICONTROL 保留中のアクション] | 管理者／全ての管理者／会社設定／保留中のアクションへのアクセス権を付与します。 |
| [!UICONTROL 環境設定] | 未使用 |
...
| [!UICONTROL セグメント公開] | セグメントを作成または編集する際に、セグメントをCX エンタープライズ版オーディエンスにする機能を付与します。 |
| [!UICONTROL サーバーコールの使用状況] | 管理者／サーバーコールの使用状況へのアクセスを付与します。 |
| [!UICONTROL 誰とでもプロジェクト リンクを共有] | Adobe Analyticsへのアクセス権を持たないユーザーに、Analysis Workspace プロジェクトへの読み取り専用アクセス権を付与します。 |
| [!UICONTROL サポート] | 管理者／全ての管理者／会社設定／サポート情報へのアクセスを付与します。 |
| [!UICONTROL トラフィック管理] | 管理者／全ての管理者／トラフィック管理へのアクセス権を付与します。 |
