...
| 個別訪問者 | x |  |  |  | コンバージョン／個別訪問者変数へのアクセスを許可します。現代の実装では一般的に使用されません。 |
...
| --- | --- | --- | --- | --- | --- |
| コードマネージャー | x |  |  |  | 従来の目的のために保存されました。管理者／コードマネージャーへのアクセスを許可します。ほとんどの場合、代わりに、Adobe Experience Platform Launch に含まれるライブラリを使用します。 |
| コードマネージャー - Web サービス | x |  |  |  | 1.4 API を使用して Code Manager へのアクセスを許可します。 |
| レポートスイートを非表示 | x |  |  |  | 管理者／カンパニー設定／レポートスイートを非表示へのアクセスを許可します。レポートスイートへのアクセス権に関係なく、組織内の任意のレポートスイートを非表示にする機能を付与します。 |
| 統合 (作成) | x |  |  |  | 管理者／Data Connectors へのアクセスを許可し、ユーザーが Data Connectors を作成できるようにします。 |
| 統合 (削除) | x |  |  |  | 管理者／Data Connectors へのアクセスを許可し、ユーザーが Data Connectors を削除できるようにします。 |
| 統合 (更新) | x |  |  |  | 管理者／Data Connectors へのアクセスを許可し、ユーザーが既存のコネクタ設定を変更できるようにします。 |
| ログ | x |  |  |  | 管理者／ログへのアクセスを許可します。 |
| ログ - Web サービス | x |  |  |  | 1.4 API を介したプルログへのアクセスを許可します。 |
| 保留中のアクション | x |  |  |  | 管理者／カンパニー設定／保留中のアクションへのアクセスを許可します。 |
| セキュリティ | x |  |  |  | 管理者／カンパニー設定／セキュリティマネージャーへのアクセスを許可します。 |
| サーバーコールの使用状況 | x |  |  |  | 管理者／サーバーコールの使用状況へのアクセスを許可します。 |
| サポート | x |  |  |  | 管理者／カンパニー設定／サポート情報へのアクセスを許可します。 |
...
| ブランド提携 |  |  |  | x | 廃止。管理者／カンパニー設定／ブランド提携へのアクセスを許可します。 |
| Excel ライセンスユーザー |  |  |  | x | 未使用。 |
| モバイルアプリ管理者 |  |  |  | x | 未使用。 |
| 権限管理 |  |  |  | x | 廃止。管理者／ユーザー管理の下にある従来のユーザー管理インターフェイスへのアクセスを許可します。 |
