...
| データフィードマネージャー | x |  |  |  | Analytics のトップナビゲーションで管理者／データフィードへのアクセス権を付与します。 |
| データ修復 API | x |  |  |  | データ修復 API へのアクセスを許可 |
| データソースマネージャー | x |  |  |  | Analytics のトップナビゲーションで管理者／すべての管理者／データソースへのアクセス権を付与します。権限項目「Report Suite Mgmt」が必要です。 |
