...
<table id="table_36FD7EF1DAB44D359F4FC186D93147E5"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>移行開始日前は、Admin Console または Analytics／ユーザー管理でユーザーを作成できます。 </p> <p>移行開始後は、Admin Console でのみユーザーおよび権限グループを作成できます。 </p><p>移行開始日に行われる処理の詳細については、以下の「移行」の節を参照してください。 </p>
   </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>これらの機能は、引き続き Analytics のユーザー管理で使用できます。 </p> <p>詳細については、<a href="/help/admin/admin-console/user-management2/user-migration/c-migration-tool.md">Admin Console でサポートされない Analytics の機能</a>を参照してください。 </p> </td> 
  </tr> 
  <tr> 
