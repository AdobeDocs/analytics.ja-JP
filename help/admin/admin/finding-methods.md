...
**[!UICONTROL Analytics/管理者]** / **[!UICONTROL レポー]** トスイ **[!UICONTROL ート]** /設定の編集/コ ************&#x200B;ンバージョン検索方法
...
> [!NOTE] すべての検索方法は、訪問が終了すると期限が切れます。 「有効期限」を別のイベント（チェックアウトなど）に設定した場合、検索方法は訪問中にチェックアウトが発生した時点で有効期限が切れます。訪問中にチェックアウトが発生しなかった場合、検索方法はその訪問が終了すると有効期限が切れます。
