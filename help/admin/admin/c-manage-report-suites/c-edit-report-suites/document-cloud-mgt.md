...
* [!UICONTROL **Document Cloud レポート**]
  ...
  ストリーミングメディアサービスに固有のレポートは、メディアレポート ページで使用できます。 メディアレポートについて詳しくは、[Document Cloud レポートの設定 ](/help/admin/admin/c-manage-report-suites/c-edit-report-suites/document-cloud-config.md) を参照してください。
