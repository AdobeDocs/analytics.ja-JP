...
レポートスイートでは、次のデータストアのいずれかに関する完全な独立レポートが定義されます。

* 単一の Web サイト（最も典型的）

* 単一の Web サイトの一部またはサブセット

* 合計を得るための複数のサイトの数で構成されるグローバルセグメント
...
<table id="table_F739FBD8DB8D409E916F12F61C5953D0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"><a href="/help/admin/admin/c-manage-report-suites/c-new-report-suite/new-report-suite.md">新しいレポートスイート</a>を参照してください。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>管理ツール、およびマーケティングレポートヘッダーのレポートスイートドロップダウンリストで、レポートスイートを識別します。 </p> <p><a href="/help/admin/admin/c-manage-report-suites/c-new-report-suite/new-report-suite.md">新しいレポートスイート</a>を参照してください。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="wintitle"> ベース URL</span> </td> 
   <td colname="col2"> <p>レポートスイートのベースドメインを定義します。 </p> <p><a href="/help/admin/admin/c-manage-report-suites/c-new-report-suite/new-report-suite.md">新しいレポートスイート</a>を参照してください。 </p> </td> 
  </tr> 
 </tbody> 
</table>
