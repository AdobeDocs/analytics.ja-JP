...
| 概要数値 | 説明 |
| --- | --- |
| [!UICONTROL ユーザー] | 現在、このレポートスイートにレポートリクエストを送信しているユーザーの数。 |
...
1. テーブル内の 1 つ以上の&#x200B;**[!UICONTROL クエリ ID]** の左側にあるボックスをオンにして、下部にある「**[!UICONTROL リクエストをキャンセル]**」をクリックします。
   ...
   [!UICONTROL ユーザー]別、[!UICONTROL プロジェクト]別または[!UICONTROL アプリケーション]別に詳細を表示して、リクエストを一括でキャンセルすることもできます。キューになかったかキャンセル時に実行中だったプロジェクト、ユーザーまたはアプリケーションに対する後続のリクエストは、アクティビティが更新されると表示されることがあります。
