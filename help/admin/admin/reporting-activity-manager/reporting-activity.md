...
1. 各レポートスイートの使用状況情報を表示します。 テーブルに表示されるデータは、ページが最後に読み込まれた時点のレポートスイートのレポートアクティビティを表します。
   ...
   | **[!UICONTROL ステータス]** | 可能なステータスは次のとおりです。 <ul><li>[!UICONTROL **アクティブ**] （青）：過去 2 時間以内にレポートスイートでレポートが実行されている。 表に示すデータは、ページが最後に読み込まれた時点でのレポートスイートのレポート容量を表しています。</li><li>[!UICONTROL **非アクティブ**] （グレー）：過去 2 時間以内にレポートスイートで実行されたレポートがないので、そのレポートスイートのデータは表示されません。</li></ul> |
