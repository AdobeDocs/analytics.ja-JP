...
1. 選択 [!UICONTROL **リクエストをキャンセル**].
   ...
   The [!UICONTROL **x 件のレポートリクエストのキャンセル**] ダイアログボックスが表示されます。
...
1. 選択 [!UICONTROL **リクエストをキャンセル**].
   ...
   The [!UICONTROL **x 人のユーザーからの x 件のレポートリクエストをキャンセルします**] ダイアログボックスが表示されます。
...
1. 選択 [!UICONTROL **リクエストをキャンセル**].
   ...
   The [!UICONTROL **x 個のプロジェクトから x 個のレポートリクエストをキャンセルします。**] ダイアログボックスが表示されます。
...
Analysis Workspaceで、キャンセルされたレポートへのアクセスを試みるユーザーには、次のメッセージが表示されます。
