...
管理ログは、管理ツールで管理者が実行した変更をすべて報告します。ログは、3 つのログのいずれかからユーザー定義のレポートへのゲートウェイを提供します。指定した日付範囲で、選択した条件に一致するイベントを検索できます。
...
| イベントタイプ | 説明 |
| --- | --- |
| カテゴリなし | 任意のイベントタイプにすることができます。 |
| ログインに失敗しました | ユーザログインプロセスに失敗しました。 |
| ログイン成功 | ユーザーが正常にログインしました。 |
| 管理アクション | レポートスイートの編集、会社設定の変更、ユーザーの作成、レポートリクエストのキャンセルなど、管理アクションが発生しました。 |
| セキュリティ設定の変更 | セキュリティ設定が変更されました。 |
| 表示されたレポート | Reports &amp; Analytics レポートが表示されました。 |
| ダウンロードしたレポート | Reports &amp; Analytics レポートがダウンロードされました。 |
| 送信済みアラート | アラートが送信されました。 |
| ユーザーアクション | ユーザ情報が編集されました。 |
| 表示されたツール | ツールが表示されました。 |
| Omniture Action | アクションがAdobeで実行されました。 |
| パスワードの復元 | パスワードが復元されました。 |
| BookMarks | ブックマークが管理されました。 |
| ダッシュボード | ダッシュボードが管理されていました。 |
| アラート | アラートが管理されました。 |
| カレンダーイベント | カレンダーイベントが管理されました。 |
| ターゲット | ターゲットが管理されました。 |
| レポート設定 | レポート設定が管理されました。 |
| スケジュールされているレポート | 予定レポートが管理されました。 |
| IP で除外 | IP 設定が変更されました。 |
| ページ名変更 | 非推奨です。 |
| 分類 | 分類が管理されました。 |
