...
1 つの IP アドレスまたは同じブロック内の複数のアドレスを、ワイルドカード (&#42;) をクリックします。 照合する IP アドレスの数値を指定します。代用 &#42; ワイルドカードを使用して照合する値に対して。 次に、IP アドレスの照合文字列の例を示します。
...
照合する IP アドレスの開始と終了の範囲を指定します。代用 &#42; ワイルドカードを使用して照合する値に対して。
