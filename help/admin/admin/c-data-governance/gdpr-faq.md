...
Adobeアカウントチームに連絡し、エンジニアリングアーキテクトコンサルティングチームと調整して、PII やデータの問題を解決するための労力のレベルをさらに確認し、提供してください。
...
Adobeアカウントチームに連絡し、エンジニアリングアーキテクトコンサルティングチームと協力して、さらに検討し、PII やデータに関する問題を解決するための労力のレベルを確認してください。
