...
I1、I2、S1 および S2 ラベルは、Adobe Experience Platformのそれに対応する名前の DULE ラベルと同じ意味を持ちます。 ただし、これらは非常に異なる目的で使用されます。 Adobe Analytics内では、これらのラベルは、Privacy Serviceリクエストの結果として匿名化する必要があるフィールドを識別するために使用されます。 Adobe Experience Platform内では、アクセス制御、同意管理、ラベル付きフィールドにマーケティング制限を適用するために使用されます。 Adobe Experience Platformでは、Adobe Analyticsで使用されない多くの追加ラベルをサポートしています。 Analytics Data Connector を使用してAdobe Analytics データをAdobe Experience Platformに読み込む場合は、Adobe Analytics内に適用した I1、I2、S1、S2 ラベルが、読み込まれたレポートスイートで使用されるAdobe Experience Platformのスキーマにも適用されていることを確認する必要があります。
