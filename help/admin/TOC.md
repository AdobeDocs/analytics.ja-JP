...
product: analytics
audience: admin
user-guide-title: Analytics管理ガイド
...
+ [Analytics管理ヘルプ](home.md)
+ Analytics Admin overview {#admin-overview}
   + [どのAdobe Analyticsツールを使用する必要がありますか。](c-analytics-product-comparison/which-analytics-tool.md)
...
+ 管理ツール {#admin-tools}
   ...
   + コンバージョン変数 {#conversion-variables}
      ...
      + [コンバージョン分類](admin/conversion-var-admin/conversion-classifications.md)
   ...
   + 有料検索検知 {#paid-search-detection}
      + [有料検索検出の概要](admin/paid-search-detection/paid-search-detection.md)
   ...
   + 処理ルール {#processing-rules}
      ...
      + Processing rules configuration {#processing-rules-configuration}
         + [処理ルールの動作](admin/c-processing-rules/c-processing-rules-configuration/processing-rules-about.md)
      ...
      + Processing rules examples {#processing-rules-examples}
         ...
         + [クエリ文字列パラメータからのキャンペーンIDの入力](admin/c-processing-rules/processing-rules-examples/processing-rules-populate-campaign-id.md)
         + [製品の概要ページから製品表示イベントを設定する](admin/c-processing-rules/processing-rules-examples/setting-the-product-view-event.md)
         + [カテゴリとページ名を連結してサブカテゴリを追加](admin/c-processing-rules/processing-rules-examples/subcategory-concatenating.md)
         + [eVar値をpropにコピーしてパスを特定する](admin/c-processing-rules/processing-rules-examples/processing-rules-determining-path.md)
         + [レポート内の値のクリーンアップ](admin/c-processing-rules/processing-rules-examples/clean-up-values-in-a-report.md)
         + [クエリ文字列パラメータを使用して内部検索用語を入力する](admin/c-processing-rules/processing-rules-examples/processing-rules-populating-internal-search.md)
         + [コンテキストデータ変数のeVarへのコピー](admin/c-processing-rules/processing-rules-examples/processing-rules-copy-context-data.md)
   ...
   + リアルタイムレポート{#real-time-reports}
      ...
      + [サポートされるリアルタイム指標およびディメンション](admin/realtime/realtime-metrics.md)
   ...
   + Server-side forwarding {#server-side-forwarding}
      ...
      + [サーバー側転送データとコードリファレンス](admin/c-server-side-forwarding/ssf-reference.md)
      + [サーバー側転送の実装を検証する方法](admin/c-server-side-forwarding/ssf-verify.md)
      + [サーバー側転送に関するFAQ](admin/c-server-side-forwarding/ssf-faq.md)
...
+ Experience Cloud Admin Console {#admin-console}
   ...
   + 権限 {#permissions}
      ...
      + [レポートスイートツールの権限項目](admin-console/permissions/report-suite-tools.md)
      + [Analyticsツール権限項目](admin-console/permissions/analytics-tools.md)
   + [Adobe Analytics First Admin Guide](admin-console/first-admin-guide.md)
   + [レポートスイートの作成](admin-console/create-report-suite.md)
+ カンパニー設定 {#company-settings}
   + [会社設定の概要](company/c-company-settings.md)
   ...
   + [レポートスイートの非表示](company/c-hide-report-suites.md)
...
+ Manage report suites {#manage-report-suites}
   ...
   + Report suite templates {#report-suite-templates}
      ...
      + [アグリゲーターポータル](c-manage-report-suites/c-report-suite-templates/aggregator-portal.md)
...
+ User and Product Management (Legacy) {#user-product-management}
   ...
   + User groups {#user-groups}
      ...
      + [ユーザーグループの設定](user-management2/c-user-groups/groups.md)
   + Customize report access {#customize-report-access}
      ...
      + [Analyticsツールの権限のカスタマイズ](user-management2/c-customize-report-access/groups-analytics-tools.md)
      ...
      + [ディメンション権限のカスタマイズ](user-management2/c-customize-report-access/groups-dimensions.md)
...
+ データガバナンス {#data-governance}
   ...
   + [Adobe Analytics GGPRワークフロー](c-data-governance/an-gdpr-workflow.md)
   + [レポートスイートのデータガバナンス設定の表示/管理](c-data-governance/gdpr-view-settings.md)
   + [ラベルレポートスイートのデータ](c-data-governance/gdpr-setup-reportsuite.md)
   + [リクエストの送信および削除](c-data-governance/gdpr-submit-access-delete.md)
   + [Analytics変数のDGPRラベル](c-data-governance/gdpr-labels.md)
   + [名前空間](c-data-governance/gdpr-namespaces.md)
   + [IDの拡張](c-data-governance/gdpr-id-expansion.md)
   + [ラベル付けのベストプラクティス](c-data-governance/gdpr-analytics-ids.md)
   + [ラベルの例](c-data-governance/gdpr-labeling-example.md)
   + [GDPR と Data Connectors（Genesis）](c-data-governance/data-connectors-gdpr.md)
   + [GGPRの用語](c-data-governance/gdpr-terminology.md)
+ サーバーコールの使用状況 {#server-call-usage}
   ...
   + [サーバーコールの使用に関するFAQ](c-server-call-usage/overage-faq.md)
+ トラフィック管理 {#traffic-management}
   + [ダミー-削除](admin/c-traffic-variables/traffic-classifications.md)
   ...
   + [トラフィック増加に必要なリードタイム](c-traffic-management/traffic-lead-time.md)
