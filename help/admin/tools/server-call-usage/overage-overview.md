...
* **権限：** Adobe Analytics Administrator アクセス権または[Server Call Usage](/help/admin/admin-console/permissions/analytics-tools.md)権限をAdobe Admin Consoleに持っている必要があります。 管理者は、製品プロファイルを通じて、この権限項目を管理者以外のユーザーに割り当てることができます。
