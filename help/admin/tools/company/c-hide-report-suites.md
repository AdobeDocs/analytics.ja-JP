...
自分やユーザーがレポートスイートを使用できない場合は、表示から非表示にすることができます。 レポートスイートを非表示にしたい理由として、実装の変更や、誰かがレポートスイートを誤って作成したことが考えられます。

レポートスイートを非表示にすると、レポートスイートセレクタードロップダウンメニュー、管理ツール、またはレポートスイートが表示されるその他の場所にレポートスイートが表示されなくなります。 レポートスイートのデータが非表示になるまで、Adobe Analytics インターフェイスを介してレポートスイートのデータにアクセスできなくなります。
