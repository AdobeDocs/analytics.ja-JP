...
description: 分類を使用して、値を関連するグループに分類し、グループレベルでレポートします。 例えば、あらゆる有料検索キャンペーンを、ビデオカードのようなカテゴリーに分類できます。 そして、インスタンス（またはクリックスルー）などの指標に関連して、そのカテゴリの成功をレポートすることができます。
...
分類を使用して、値を関連するグループに分類し、グループレベルでレポートします。 例えば、あらゆる有料検索キャンペーンを、ビデオカードのようなカテゴリーに分類できます。 そして、インスタンス（またはクリックスルー）などの指標に関連して、そのカテゴリの成功をレポートすることができます。
...
| 用語 | 定義 |
|--- |--- |
| テキストの分類 | レポート目的で変数データをグループ化できる分類カテゴリのタイプを指定します。 |
| 名前 | 分類の名前。 追加した分類は、「マーケティングチャネルマネージャー」の「チャネルの内訳」オプションとして表示されます。 |
