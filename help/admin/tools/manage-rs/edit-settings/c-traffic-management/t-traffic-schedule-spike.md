...
アドビは、高トラフィックのイベントを成功させるために、クライアントとパートナーシップを構築しようとしています。 トラフィックスパイクをスケジュールすることは、そのパートナーシッププロセスの出発点となります。 「スパイクのスケジュール」セクションでは、一時的なトラフィックスパイクをアドビに警告し、その処理に適切なリソースに割り当てることができるようにします。 過去のサーバーコールを推定することで、スケジュールする必要があるトラフィックスパイクの規模をより正確に把握できます。

複数の専門スタッフによる高度なサーバーサイドのデータバランシングを行い、すべてのお客様が可能な限り最新のレポートを確実に入手できるようにします。 組織がトラフィックのスパイクをアドビに通知すると、アドビはトラフィック急増が肯定的なエクスペリエンスであることを確認できます。 トラフィックの増加をアドビに通知しないと、重要なレポート期間中の待ち時間（レイテンシー）が長くなる可能性があります。
...
* データが待ち時間に入り始めると、トラフィックスパイクをスケジュールしている組織が優先されます。 休暇シーズン中は、多くの組織がトラフィックスパイクをスケジュールするため、この概念の重要性は特に高くなります。
...
* すべてのトラフィックスパイクのリードタイムをスケジュールします。 **11 月から 12 月に予想されるトラフィックスパイクは、9月15日（PT）までにスケジュールすることが特に重要です**。 期限に間に合わなかった場合は、できるだけ早くスパイクをスケジュールします。 リードタイムはまったくないより短くてもあった方がよく、アドビは現在のリソースを活用して、お客様のレポートスイートにできる限り対応します。
* スケジュールされたトラフィックスパイクについてアドビから連絡があった場合は、リアルタイムのレポートとフル処理のレポートのどちらがより重要かを必ず伝えてください。 一部の組織は、他よりもリアルタイムのレポートに大きく依存しています。 使用するレポートのタイプがわかると、それに応じてアドビが優先順位を付けるうえで役に立ちます。
* 最も重要なレポートを作成し、それをAdobeアカウントチームと共有することで、アカウントチームが重要なレポートを適切に管理し、支持してくれるようになります。
