...
* 単一の web サイトの一部またはサブセット

* いくつかのサイトの数値の合計で構成されるグローバルセグメント

Adobe Analytics ソリューションでは、これらのデータストアを集計し、レポートを作成できます。 管理者レポートスイートマネージャーを使用すると、レポートスイートでのデータの処理方法を管理するルールを定義できます。

Adobe Analytics ソリューションにログインしたら、使用するレポートスイートを 1 つ選択します（レポートスイートを組み合わせたロールアップを使用する場合を除く）。

レポートスイートにアクセスするには：

**[!UICONTROL Analytics]**／**[!UICONTROL 管理者]**／**[!UICONTROL すべての管理者]**／**[!UICONTROL レポートスイート]**
...
次の表は、[!UICONTROL Report Suite Manager] ページの要素を示しています。
...
<table id="table_F739FBD8DB8D409E916F12F61C5953D0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> レポートスイートリストで特定のレポートスイートを検索できます。 検索ツールには、基本的な名前ベースの検索と、詳細な検索をおこなうための高度な検索ページの両方が含まれています。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="wintitle">グループ </span> </td> 
   <td colname="col2"> <p>レポートスイートをカスタムグループに整理できます。 同じ設定を共有する複数のレポートスイートや、共通して編集する複数のレポートスイートにすばやくアクセスできます。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>ロールアップとは、他の複数のレポートスイートのトラッキングデータを組み合わせる単一のレポートスイートのことです。 </p> <p><a href="/help/admin/tools/manage-rs/rollup-report-suite.md">ロールアップレポートスイート</a>を参照してください。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"><a href="/help/admin/tools/manage-rs/new-rs/new-report-suite.md">新しいレポートスイート</a>を参照してください。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>管理ツール、およびマーケティングレポートヘッダーのレポートスイートドロップダウンリストで、レポートスイートを識別します。 </p> <p><a href="/help/admin/tools/manage-rs/new-rs/new-report-suite.md">新しいレポートスイート</a>を参照してください。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="wintitle"> ベース URL</span> </td> 
   <td colname="col2"> <p>レポートスイートのベースドメインを定義します。 </p> <p><a href="/help/admin/tools/manage-rs/new-rs/new-report-suite.md">新しいレポートスイート</a>を参照してください。 </p> </td> 
  </tr> 
 </tbody> 
</table>
