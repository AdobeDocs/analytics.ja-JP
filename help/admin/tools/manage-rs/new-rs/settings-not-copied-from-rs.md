---
description: レポートスイートを複製する際に、どの設定がコピーされないかを確認します。
...
既存のレポートスイートから設定をコピーすると、新しいレポートスイートにコピーされていない設定がシステムメッセージで識別されます。

次の設定は、テンプレートまたは重複したレポートスイートからコピーされません。
...
* [階層](/help/components/dimensions/overview.md#retired-dimensions) ラベル
