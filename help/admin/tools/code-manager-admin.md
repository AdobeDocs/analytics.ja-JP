...
| 列 | 説明 |
|--- |--- |
| [!UICONTROL 名前] | 名前は、データ収集を有効にするプラットフォームと一致します。 ネイティブライブラリは、この列にリストされている各プラットフォームに対して提供されます。 |
| [!UICONTROL タイプ] | 各ライブラリを使用して測定できるアプリケーションのタイプ。 |
| [!UICONTROL バージョン] | ライブラリの最新バージョンを一覧表示します。 バージョン番号をクリックして、[&#x200B; リリース履歴](/help/implement/appmeasurement-updates.md)を表示します。 |
| [!UICONTROL ドキュメント] | ライブラリのリファレンスドキュメントを表示します。 |
