...
>[!NOTE]
>
>prop は常に大文字と小文字が区別されません。eVar もデフォルトでは大文字と小文字が区別されませんが、アドビカスタマーケア経由で区別するように変更できます。IDを含む大文字と小文字の区別があるeVarの場合は、データプライバシーリクエストを送信する際に、リクエストで使用される大文字と小文字が一致するように、適切な大文字と小文字を区別する必要があります。
