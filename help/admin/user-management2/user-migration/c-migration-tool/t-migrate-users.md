...
>[!NOTE]
>
>Experience cloud経由でログインしていない管理者がユーザーID移行ツールにアクセスしようとすると、Experience cloudのログインページにリダイレクトされます。
