...
すべてのユーザーに電子メールを送信するには、**[!UICONTROL Analytics]** / **[!UICONTROL 管理者]** / **[!UICONTROL すべての管理者]** / **[!UICONTROL ユーザー管理]** / [ユーザーへのメール](https://docs.adobe.com/help/en/analytics/admin/user-product-management/t-email-users.html)に移動します。
