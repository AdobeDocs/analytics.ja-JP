...
* 管理者として、セグメントを会社全体およびすべてのユーザーで使用すると良いと判断される場合は、セグメントを&#x200B;**[!UICONTROL 全員]**&#x200B;で共有します。この場合、[承認済み](/help/components/c-segmentation/c-segmentation-workflow/seg-approve.md)のセグメントにすることを検討してください。
