...
| 仮想レポートスイートの ID を調べる方法を教えてください。 | <ul><li>Workspace プロジェクトを開くには、レポートスイートセレクターをクリックし、検索ボックスで仮想レポートスイートの名前を検索します。ID は、検索結果の名前の下に表示されます。<br>![](assets/vrs-id.png)</li><li> または、プログラムによって、[Virtual Report Suite API](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/vrs.md) で使用できます。</li></ul> |
