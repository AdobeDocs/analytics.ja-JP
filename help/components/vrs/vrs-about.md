...
| すべての Analytics ツール（Analysis Workspace、Report Builder など）で機能 | はい。**メモ：** 仮想レポートスイートとして編集および識別できるのは、[!UICONTROL Analytics]/[!UICONTROL  コンポーネント ]/[!UICONTROL  仮想レポートスイート ] のみです。 ただし、他のツール内でも、レポートスイートのドロップダウンで選択することは可能です。<p>**重要**：レポート時間処理と変数のカスタマイズを含む仮想レポートスイートは、現在Adobe Report Builderではサポートされていません。 | ○ |
