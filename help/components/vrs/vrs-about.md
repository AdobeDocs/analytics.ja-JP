...
* セグメントに関する制限は、仮想レポートスイートにも適用されます

   仮想レポートスイートは、レポートスイートに適用されるセグメントに過ぎません。各レポートスイートには独自のData Warehouseと独自のデータフィードがあるので、複数のレポートスイートを使用すると、セグメントによって提供されない利点があります。
* リアルタイムレポート
...
場合によっては、仮想レポートスイートとマルチスイートタギングの両方を使用するメリットがあります。
