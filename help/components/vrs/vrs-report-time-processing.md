...
* **「（低トラフィック） 」または「ユニークが超過しました」のDimension:** （低トラフィック）の行項目は、レポート時間処理を使用する場合は若干異なる方法で決定され、ベースレポートスイートでのレポート時に確認される内容と一致する保証はありません。 また、低トラフィックに含まれないディメンション行項目は、ベースレポートスイートとは異なり、その行項目のデータの 100%を表すとは保証されません。 これらの違いは、ディメンションに存在する一意の値の数が多いほど顕著になります。
