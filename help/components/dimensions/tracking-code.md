...
「トラッキングコード」 [ディメンション](overview.md) サイト上のトラッキングコードの名前を一覧表示します。 異なるクエリ文字列パラメーター値を持つリンクは、インターネット上の異なる場所に配置できます。このディメンションは、どのリンクがサイトへのトラフィックの増加に最も成功したかを把握するのに役立ちます。
