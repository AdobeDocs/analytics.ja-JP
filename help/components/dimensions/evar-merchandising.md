...
外部キャンペーンまたは外部検索語の成功を測定する場合、一般的には発生する成功イベントすべてに対応するクレジットを受け取る 1 個の値が必要になります。 例えば、顧客がメールキャンペーンのリンクをクリックしてweb サイトにアクセスした場合、その結果として行われたすべての購入は、そのキャンペーンに入金される必要があります。
