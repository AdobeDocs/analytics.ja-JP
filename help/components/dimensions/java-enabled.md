...
「Java が有効」 [ディメンション](overview.md) その時点のブラウザーで Java が有効になっているかどうかを判断します。 Java ベースの機能をサイトに導入し、既に Java が有効になっている訪問者の数を知りたい場合に便利です。Java を無効にしているユーザーには、Java を有効にする方法に関する代替情報や指示を提供できます。
