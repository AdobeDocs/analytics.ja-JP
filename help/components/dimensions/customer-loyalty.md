...
「顧客ロイヤルティ」 [&#x200B; ディメンション &#x200B;](overview.md) は、以前の購入が 0 件、以前の購入が 1 件、以前の購入が 2 件、または以前の購入が 3 件以上になったサイトへの訪問者数をレポートします。 このディメンションは、サイトが購入行動に与える影響を理解するうえで役立ちます。また、このディメンションをセグメントで使用して、再購入する訪問者に焦点を当てることもできるので、新しい訪問者に対しても同様の動作を奨励できます。
