...
訪問者が購入する（`purchase` イベントをトリガーする）と、そのヒットとそれ以降のすべてのヒットが次の「バケット」に移動します。 例えば、訪問者が初めて自分のサイトで製品を購入した場合、その訪問者は「非顧客」から「新規顧客」に移動し、その注文は「新規顧客」に分類されます。 ディメンション項目「非顧客」には、注文を紐付けることはできません。
