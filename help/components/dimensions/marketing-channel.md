...
*このヘルプページは、Analysis Workspaceのマーケティングチャネル [&#x200B; ディメンション &#x200B;](overview.md) を参照します。 マーケティングチャネルがコンセプトとしてどのように機能するかについて詳しくは、「[マーケティングチャネルの概要](../c-marketing-channels/c-getting-started-mchannel.md)」を参照してください。*
