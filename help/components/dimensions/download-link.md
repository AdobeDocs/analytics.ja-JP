...
AppMeasurementを使用してこのディメンションにデータを入力するには、リンクタイプ引数`"d"`を指定して[`tl()`](/help/implement/vars/functions/tl-method.md) イメージリクエストを送信します。 リンク名引数を目的の値に設定します。
