...
一般にマーケティングチャネルは、サイトに訪問者がどのように到達するかを把握するのに使用されます。追跡するチャネルと追跡する方法に応じて、マーケティングチャネル処理ルールをカスタマイズできます。
...
使用するチャネルの定義は、マーケティングチャネルの最も重要なコンポーネントの 1 つです。チャネルの定義では、組織内の複数の個人間での共同作業が必要になる場合があります。考慮すべき質問は、次のとおりです。

* 有料検索を使用していますか？
* メールキャンペーンを使用していますか？ 個別に追跡する複数のメールキャンペーンを使用していますか？
* サイトへのトラフィックを誘導する関連会社・組織はありますか？個別に追跡する関連会社・組織はありますか？
* トラッキングを別途行うのに有利な外部キャンペーンはありますか？
* すべてのソーシャルネットワークサイトを集計しますか、それとも個別に追跡するサイトはありますか？
* 追跡するコンバージョンに影響を与える可能性のある他のチャネルはありますか？
...
>[!NOTE]
>
>マーケティングチャネルが事前に設定されていない場合は、[自動セットアップ](/help/components/c-marketing-channels/c-getting-started-mchannel.md)が表示されます。この設定では、カスタマイズ可能な複数の事前設定済みのチャネルを提供します。アドビでは、これらのルールをテンプレートとして使用することをお勧めします。ただし、既に強固なチャネル定義がある場合は、自動設定をスキップできます。
...
自動設定でチャネルを作成した場合、これらのチャネル内のルールが定義されます。必要に応じて変更できます。

## マーケティングチャネルの自動セットアップ {#run-auto-setup}

マーケティングチャネルレポートには、すぐに使い始められるように 1 回限りのセットアップページが用意されています。トラッキングに使用できる複数のマーケティングチャネルを提供します。チャネルとルールの作成に慣れている場合は、この設定をスキップできます。ただし、アドビでは、ウィザードを使用してチャネルを作成することをお勧めします。自動設定を使用すると、ルールの作成方法を確認したり、独自の目的でルールを編集したりできます。事前定義済みのチャネルは、いつでも無効または削除できます。
...
1. **[!UICONTROL 設定を編集]**／**[!UICONTROL マーケティングチャネル]**／**[!UICONTROL マーケティングチャネルマネージャー]**&#x200B;をクリックします。
   ...
   >[!NOTE]
   >
   >管理ツールでチャネル設定アプリケーションにアクセスすると、[!UICONTROL マーケティングチャネル：自動セットアップ]ページが自動的に表示されます（[マーケティングチャネルマネージャー](/help/admin/tools/manage-rs/edit-settings/marketing-channels/c-channels.md)を参照）。レポートスイートに 1 つ以上のマーケティングチャネルが含まれている場合、このページは表示されません。マーケティングチャネルが含まれていない別のレポートスイートを選択しない限り、このページに再度アクセスすることはできません。
...
マスターレポートスイートをテンプレートとして使用してマーケティングチャネル設定をテストする方法。時間を節約するために、このテンプレートを一括更新で 1 つ以上の実稼動レポートスイートに適用できます。このタスクは、チャネルとルールセットに対して個別に実行します。
