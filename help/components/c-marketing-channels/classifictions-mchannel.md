...
> [!NOTE] 分類の作成について詳しくは、分類を参照してく [ださい](/help/components/c-classifications2/c-classifications.md)。
...
1. の下で、 [!UICONTROL Classifications]をクリック **[!UICONTROL Add Classification]** します（または既存のを編集します）。
