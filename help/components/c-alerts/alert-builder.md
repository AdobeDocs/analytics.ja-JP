...
![](assets/alert_builder.png)アラート名を指定します。アラート名には、レポート名または指標のしきい値を含めることができます。
...
電話番号には、先頭に「+」と[国番号[#$tu24]を付ける必要があります。
...
## 例えば、時間の精度を毎日に設定すると、プレビューにより、最近の 30 または 31 日間で、特定の指標に対してアラートが何回トリガーされたかがわかります。 {#section_10D75BA7B77E4C5FAF58A719C082E070}
