...
* このセグメントを保存するレポートスイートが、Experience Cloud[&#128279;](/help/components/segmentation/segmentation-workflow/seg-publish.md)に対して有効になっていることを確認してください。 それ以外の場合は、Experience Cloudに公開できません。
