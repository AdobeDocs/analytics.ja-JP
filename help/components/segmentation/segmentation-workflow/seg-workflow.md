...
| 手順 | アクション | 詳細 |
|:--:|---|---|
| 1 | [セグメントの計画](/help/components/segmentation/segmentation-workflow/seg-plan.md) | セグメントを作成しセグメント管理環境を設定する前に、すべての適切な質問をしましたか？ 目的と明確な使用方法を念頭に置いてセグメントを設計しましたか？<br/> セグメントの計画および整理の助けについては、[&#x200B; セグメント計画チェックリスト &#x200B;](seg-plan.md) を参照してください。 |
