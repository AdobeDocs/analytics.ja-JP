...
権限に応じて、セグメントを組織全体、グループ、または個人ユーザーと共有できます。

| 管理者 | すべてのユーザー、グループ、およびユーザーとセグメントを共有できます。 グループは、Admin Console で権限グループとして設定されます。 |
|---|---|
...
1. **[!UICONTROL セグメントを共有]** ダイアログで、次の操作を行います。
   ...
   管理者は、「**[!UICONTROL すべて]**」を選択できます。また、組織内の&#x200B;**[!UICONTROL グループ]**&#x200B;または&#x200B;**[!UICONTROL ユーザー]**&#x200B;を選択することもできます。 管理者以外は、個人ユーザーのみを表示できます。 **[!UICONTROL 検索]**&#x200B;フィールドを使用して、グループまたはユーザーを検索します。 1.
