...
![Clock](/help/assets/icons/Clock.svg) **[!UICONTROL After]**&#x200B;および![Clock](/help/assets/icons/Clock.svg) **[!UICONTROL Within]**&#x200B;の&#x200B;**[!UICONTROL Then]**&#x200B;演算子を使用して、ヒット、訪問またはディメンション ](#event-session-and-dimension-constraints)に対する追加の[時間制約](#time-constraints)または[制約を定義できます。
