...
1. 次のいずれかの方法を使用して、アラートを作成します。
   ...
   * [アラートマネージャーから](/help/components/alerts/alert-manager.md#create-alerts)アラートを作成します。
   ...
   アラートビルダーが表示されます。 このインターフェイスは、Analytics でセグメントや計算指標を作成するために使用するインターフェイスに似ています。
