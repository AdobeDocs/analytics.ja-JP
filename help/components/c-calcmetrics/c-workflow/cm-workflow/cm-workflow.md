...
| [ 共有 ](cm-sharing.md) 計算指標 | 他の [!DNL Analytics] ツールの特定の閲覧者と指標を共有します。また、Adobe Target および Adobe Experience Cloud と共有することもできます。 |
| 計算指標をフィルタリング | 指標セレクターで、「詳細選択」をクリックし、タグ、所有者およびその他のフィルター（「すべてを表示」、「自分が所有」、「自分と共有」、「お気に入り」および「承認済み」）を使用してフィルタリングします。 |
