...
レポートでカンマや重複引用符などの特殊文字を使用することは、通常はお勧めしません。 ただし、このような使用が必要になる場合もあります。分類対象として選択した文字がレポートの値に含まれている場合は、次の手順に従います。
...
数値 2 分類を使用すると、ディメンション項目を時間ベースの指標として分類できます。2019年7月にAdobe AnalyticsUIから引退。
