---
description: トラッキングコードが変更されるたびに分類を管理してアップロードするのではなく、自動的にルールベースの分類を作成して、複数のレポートスイートに適用できます。 ルールは、分類関連のトラフィック量に応じて、頻繁に処理されます。
...
トラッキングコードが変更されるたびに分類を管理してアップロードするのではなく、自動的にルールベースの分類を作成して、複数のレポートスイートに適用できます。 ルールは、分類関連のトラフィック量に応じて、頻繁に処理されます。
