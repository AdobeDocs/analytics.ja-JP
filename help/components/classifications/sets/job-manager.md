...
| **[!UICONTROL ステータス]** | 分類ジョブのステータス。 使用可能な値：**[!UICONTROL Created]**、**[!UICONTROL Queued]**、**[!UICONTROL Validated]**、**[!UICONTROL Failed validation]**、**[!UICONTROL Processing]**、**[!UICONTROL Done processing]**、**[!UICONTROL Failed processing]**、**[!UICONTROL Completed]**、または **[!UICONTROL Progress]** |
