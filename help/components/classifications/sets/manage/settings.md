...
名前、説明、通知するユーザー、サブスクリプションなど、分類セットの設定を編集できます。
...
1. **[!UICONTROL 分類セット : _分類セット_]**&#x200B;ダイアログで、「**[!UICONTROL 設定]**」タブを選択して設定を編集します。
   ...
   1. 設定を保存するには、**[!UICONTROL 保存]**&#x200B;を選択します。 「**[!UICONTROL キャンセル]**」を選択すると、キャンセルします。
