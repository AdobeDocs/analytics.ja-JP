...
分類セットと従来の分類セットの主な違いは、分類セットが、すべての機能を 1 つのインターフェイスにまとめている点です。従来の分類は 3 つのインターフェイスを使用します。

### 従来の分類

![&#x200B; レガシー分類 &#x200B;](./assets/classifications-legacy.svg)
...
分類セットは、従来のすべての分類インターフェイスを 1 つにまとめたものです。 各分類セットは、次の項目を定義します。
