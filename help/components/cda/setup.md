...
## カスタマーケアに連絡してチケットを開き、クロスデバイスレポートスイートでCDAをプロビジョニングする

CDA は、デバイス間のレポートスイートで、アドビのエンジニアリングによってプロビジョニングされます。 このプロセスを開始するには、カスタマーケアに連絡し、次の情報を提供する準備をしてください。
...
この情報をカスタマーケアに伝えたら、カスタマーケアはAdobeエンジニアリング部門と協力して、選択したレポートスイートでCDA処理を有効にします。
...
* 「[人](../metrics/people.md)」と「[一意のデバイス](../metrics/unique-devices.md)」というラベルの付いた新しい指標を使用できます。
