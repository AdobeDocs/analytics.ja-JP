...
カウントが予想よりも少し多い場合、[ハッシュの競合](/help/implement/validate/hash-collisions.md)が原因で、1つのeVar値が複数の識別済み個人に属している可能性があります。 カウントが予想をはるかに上回る場合は、その他のトラブルシューティング手順について、カスタマーケアにお問い合わせください。
