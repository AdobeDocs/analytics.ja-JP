...
* プライベートグラフを使用している場合、新しいデバイスを繋ぎ合わせるのに最大24時間かかります。
* サイトを訪問する新しいデバイスがCo-op graphで処理されるまでに最大2週間かかる場合があります。 CDA での直近の 2 週間の結び付けのレベルは、通常、2 週間よりも古い日付範囲の結び付けのレベルよりも低くなります。アドビでは、今後、Co-opグラフを毎日更新するグラフに改善する予定です。
