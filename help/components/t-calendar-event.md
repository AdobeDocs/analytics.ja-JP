...
uuid: 15d4f0c8- b566-43b0- b914-4ea35b7ac7f
...
1. Click **[!UICONTROL Add New]**.
   1. **[!UICONTROL 「タイトル]**」で、カレンダーイベントに名前を付けます。
...
1. （オプション）カレンダーイベントは、共有しない限りはユーザー専用となります。To share this event, select **[!UICONTROL Share]**.
...
1. **[!UICONTROL Analytics]** / **[!UICONTROL コンポーネント]** / **[!UICONTROL カレンダーイベント]**&#x200B;をクリックします。
1. **[!UICONTROL 「共有カレンダーイベント]**」で、次のいずれかのオプションを指定します。

       |**コピー**|元の名前と同じ名前を使用して、イベントのリストにコピーを追加します。ただし、このイベントの所有者による更新や変更は表示できません。|
       |---|---|
