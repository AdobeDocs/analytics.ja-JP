...
description: Adobe Analytics が提供する様々なコンポーネントについて学びます。
...
* **仮想レポートスイート：**&#x200B;レポートスイートに基づいてデータの仮想サイロを作成します。 データをクレンジングしたりセグメント化して、より優れたユーザーエクスペリエンスを提供できます。 一部の機能は、仮想レポートスイートでのみ使用できます。
