...
これらのリリースノートは、2024 年 7 月 17 日から 2024 年 8 月までのリリース期間を対象としています。 Adobe Analytics リリースは、[継続的な配信モデル](releases.md)に基づいて動作します。このモデルにより、機能のデプロイメントに対する、よりスケーラブルかつ段階的なアプローチが可能になります。したがって、これらのリリースノートは月に数回更新されます。 リリースノートを定期的に確認してください。

## 新機能または機能強化 {#features}

| 機能 | 説明 | [ロールアウト開始](releases.md) | [一般公開](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **リンクトラッキング 向け SDK の改善Web** | リンクトラッキング年頃のWeb SDKの最新バージョンでは、いくつかの注目すべき改善が利用可能であり、これはActivity Mapに直接利益をもたらします。 これらの新機能は、Web SDK JavaScript ライブラリ と Web SDK タグ 拡張機能の両方で利用できます。<ul><li>イベントのグループ化: 訪問者が内部リンクをクリックしたときに、リンクトラッキングの別のイベント呼び出しをトリガーする代わりに、次のページにグループ イベントデータすることを選択できます。 この機能強化により、契約上の制限に対して Web SDK が使用するイベントの数が減ります。</li><li>フィルタークリックのプロパティ: `OnBeforeLinkClickSend`置き換える新しいコールバック。 このコールバックを使用して、リンク関連データを Adobe Systems に送信する前にフィルタリングまたは難読化できます。</li></ul><p>詳しくは、Web SDK ユーザー ガイドの [clickCollection](https://experienceleague.adobe.com/en/docs/experience-platform/web-sdk/commands/configure/clickcollection) を参照してください。</p> | 開く ベータ版は2024年7月10日に開始されました | 未定 |

{style="table-layout:auto"}

## Adobe Analytics の修正点

* 固定ユーザーがAnalytics UIにログできない問題があります(AN-352953)
* 固定、ユーザーが Analytics モバイルアプリにログできない問題があります(AN-352463)
* 固定プロジェクトを PDF としてダウンロードできない問題がありました(AN-352680)
* 固定分類が読み込まれない問題が発生しました(AN-352178)

### Analytics のその他の修正

AN-352905;AN-352902;AN-352693;AN-352659;AN-352619;
AN-352577;AN-352575;AN-352572;AN-352571;AN-352549;AN-352501;AN-352499;AN-352478;AN-352466;AN-352437;AN-352378;AN-352355;AN-352341;AN-352318;AN-352297;AN-352272;AN-352267;AN-352263:AN-352088;AN-352019;AN-352018;AN-351978;AN-351908;AN-351809;AN-351750;AN-351689;AN-351624;AN-351564;AN-351524;AN-351507;AN-351416AN-351414;AN-351405;AN-351299;AN-351283;AN-351231;AN-350710;AN-349912;AN-349786;AN-348300;AN-348061;AN-347865;AN-347676:AN-347478;AN-343611;AN-343114;(AN-334124)
...
| --- | --- | --- |
| **Adobe Analytics API (バージョン 1.4) のサポート終了** | 2024年7月17日（PT） | **2026 年 8 月 12 日**&#x200B;に、次のAnalyticsレガシ API サービスがサポート終了してシャットダウンされ、これらのサービスを使用して構築された現在の統合は機能しなくなります。<ul><li>Adobe Analytics API(バージョン 1.4)</li><li>Adobe Analytics WSSE Authentication</li></ul><p>Adobe Analytics API (バージョン 1.4) を使用するインテグレーションは [Adobe Analytics 2.0 API ](https://developer.adobe.com/analytics-apis/docs/2.0/) に移行する必要があり、WSSE インテグレーションは [Adobe Systems Developer Console で OAuth ベースの認証プロトコルに移行する必要があります](https://developer.adobe.com/console)。</p><p>よくある質問への回答とさらなるガイダンスについては](/help/admin/c-admin-api/c-admin-14-api-eol.md)[Adobe Analytics 1.4 API のサポート終了に関する FAQ を参照してください。</p> |
