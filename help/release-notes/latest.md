...
| 機能 | 説明 | ターゲット日 |
| ----------- | ---------- | ------- |
| 該当なし |  | 詳しくは、[一般提供](https://experienceleague.adobe.com/docs/analytics/technotes/releases.html?lang=ja)を参照してください。 |
