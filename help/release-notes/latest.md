...
| **トランザクション ID の保持期間** | トランザクション ID の保持期間は 90 日で、2025 年 1 月に 25 か月に延長されます。 `transactionID` 変数は、ヒットがデータソースを通じてアップロードされたデータに結び付けられるように、トランザクションを一意に識別します。 |  | 2025年1月22日（PT） |
