---
description: Adobe Analyticsの様々なレポートに、表示された特定のレポートに応じて、「未指定」、「なし」、「その他」または「不明」と表示されます。 一般的に、これらの行項目は変数が定義されていなかったか、使用できなかったことを意味します。
title: レポートが未指定、なし、その他、不明
...
「未指定」は、レポートにおいてよく見られる行項目です。「なし」とも呼ばれることが多い。
