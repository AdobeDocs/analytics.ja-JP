...
カスタムのトラフィック変数またはコンバージョン変数（prop または eVar）の ID の場合は、変数に ID-DEVICE または ID-PERSON ラベルを設定してから、独自の名前空間の名前をその ID タイプに割り当てます。[変数を ID-DEVICE または ID-PERSON としてラベル設定する際の名前空間の提供](/help/technotes/c-data-governance/data-labeling/gdpr-labels.md)を参照してください。
...
詳しくは、[変数を ID-DEVICE または ID-PERSON としてラベル設定する際の名前空間の提供](/help/technotes/c-data-governance/data-labeling/gdpr-labels.md)を参照してください。
