...
+ FTP と SFTP {#ftp-and-sftp}
  ...
  + アドビがホストする FTP アカウントの設定 {#set-up-ftp-accounts}
    + [FTP アカウントのセットアップ - 概要](ftp-and-sftp/c-set-up-ftp-accounts/ftp-accounts.md)
  ...
  + [FTP の制限とデータ保持](ftp-and-sftp/ftp-limits.md)
  ...
  + [パッシブ FTP モードを使用](ftp-and-sftp/ftp-passive.md)
