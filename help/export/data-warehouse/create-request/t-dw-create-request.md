...
Data Warehouse を作成する際には、様々な設定オプションを使用できます。 次の情報では、リクエストの作成方法について説明し、その後、リクエストを完了するための詳細情報へのリンクを提供します。
...
1. [!UICONTROL **Data Warehouse**] ページで、[!UICONTROL **追加**]&#x200B;を選択します。
   ...
   新規Data Warehouse リクエストページが表示されます。

   ![一般設定タブ &#x200B;](assets/dw-general-settings.png)
