...
配信スケジュールには、一定の期間を指定できます。レポートは、通常、次の期間の初日に送信されます。遅くても、2 日目の朝には送信されます。これらの配信スケジュールは、いつでも変更または停止できます。[!UICONTROL Ad Hoc Analysis] が配信するレポートについて詳しくは、[Ad Hoc Analysis ヘルプ](https://marketing.adobe.com/resources/help/ja_JP/dsc/index.html#Discover_Help)を参照してください。
