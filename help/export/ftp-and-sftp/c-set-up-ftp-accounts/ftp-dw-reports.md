...
>[!NOTE]
>
>次の情報は、FTPおよびSFTPの宛先タイプに関連しています。 FTPとSFTPは従来の宛先タイプです。 データウェアハウスレポートを設定する際には、より安全なクラウド宛先タイプを使用する必要があります。 Data Warehouse レポートのクラウド宛先タイプの設定について詳しくは、[Data Warehouse リクエストの作成](/help/export/data-warehouse/create-request/t-dw-create-request.md)を参照してください。
