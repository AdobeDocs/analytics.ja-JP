...
| `cookies` | 「cookie サポート」ディメンションで使用される変数。<br>Y：有効<br>N：無効<br>U：不明 | char(1) |
...
| `last_purchase_num` | 「顧客の忠誠度」ディメンションで使用される変数。訪問者がこれまでにおこなった購入の回数を示します。<br>0：過去に購入したことがない（顧客以外）<br>1：過去に 1 回購入したことがある（新規顧客）<br>2：過去に 2 回購入したことがある（リターン顧客）<br>3：過去に 3 回以上購入したことがある（常連客） | int unsigned |
