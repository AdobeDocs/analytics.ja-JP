...
| **`ref_type`** | ヒットのリファラルのタイプを表す数値 ID。 [ リファラータイプ ](/help/components/dimensions/referrer-type.md) ディメンションで使用します。 <p>1: サイト内</p><p>2：その他の Web サイト</p> <p>3：検索エンジン</p> <p>4: ハードドライブ</p> <p>5: USENET</p> <p>6：型指定/ブックマーク（リファラーなし）</p> <p>7 : メール</p> <p>8:JavaScriptなし</p> <p>9：ソーシャルネットワーク</p><p>10：対話型 AI ツール</p> | tinyint unsigned |
