...
+++
   ...
   RBAC 認証を使用して、Azure コンテナに直接フィードを送信できます。 この宛先の種類には、アプリケーション ID、テナント ID、およびシークレットが必要です。
...
+++
   ...
   SAS 認証を使用して、Azure コンテナに直接フィードを送信できます。 この宛先の種類には、アプリケーション ID、テナント ID、キーボールト URI、キーボールト秘密鍵名、および秘密鍵が必要です。
