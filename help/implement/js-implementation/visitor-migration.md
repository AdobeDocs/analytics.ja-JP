...
* `2o7.net` から `omtrdc.net`（[地域データ収集](https://marketing.adobe.com/resources/help/ja_JP/whitepapers/rdc/)）に移行するとき。

* [Experience Cloud 訪問者 ID サービス](https://marketing.adobe.com/resources/help/ja_JP/mcvid/) を実装、および CNAME／ファーストパーティデータ収集ドメインから `2o7.net` または `omtrdc.net`（[地域データ収集](https://marketing.adobe.com/resources/help/ja_JP/whitepapers/rdc/)）に移行するとき。

* `2o7.net` または `omtrdc.net` から CNAME／ファーストパーティデータ収集（[ファーストパーティ Cookies）](https://marketing.adobe.com/resources/help/ja_JP/whitepapers/first_party_cookies/) に移行するとき。
...
<table id="table_7B2535FC3E264216A299686415C6B21C"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <b>準備：</b><a href="https://helpx.adobe.com/jp/marketing-cloud/contact-support.html" format="http" scope="external">カスタマーケアに連絡して</a>、移行するドメインと、有効にする移行期間（30 日、60日または 90 日）を伝えます。安全性を確保したドメインもそうでないドメインも必ず含めてください。 </p> </td> 
