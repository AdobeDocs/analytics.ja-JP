...
**タイムスタンプオプション**&#x200B;を使用すると、ライブWebサイトからのタイムスタンプのないデータをモバイルデバイスからのオフラインデータと統合したり、タイムスタンプのないアプリをタイムスタンプのあるアプリに更新したりできます。 ![](assets/timestamp_v_non6.png)
...
>[!IMPORTANT]
>
>組み合わせがグローバルレポートスイートで意味をなすように、各コンポーネントデータセットのデザインを慎重に計画してください。
...
* [s.visitorID](https://marketing.adobe.com/resources/help/en_US/sc/implement/?f=visid_custom) が設定されている場合のタイムスタンプの使用は、推奨されません。データの順番がばらばらになる可能性があります。
