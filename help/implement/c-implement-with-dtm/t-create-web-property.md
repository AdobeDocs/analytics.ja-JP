...
> [!NOTE]プロパティを作成できるのは管理者権限を持つユーザーのみです。ロールについて詳しくは、Dynamic Tag Management製品ドキ [ュメントの「DTMでのグループの作成](https://marketing.adobe.com/resources/help/en_US/dtm/groups.html) と管理」を参照してください。
