...
| `_experience.analytics.customDimensions.`<br/>`lists.list1.list[].value` -<br/>`_experience.analytics.customDimensions.`<br/>`lists.list3.list[].value` | すべてを連結 `value` 各 `list[]` 配列を [リスト変数](../vars/page-vars/list.md). |
