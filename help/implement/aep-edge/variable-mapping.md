...
| `_experience.analytics.customDimensions.`<br/>`lists.list1.list` -<br/>`_experience.analytics.customDimensions.`<br/>`lists.list3.list` | それぞれの[リスト変数](../vars/page-vars/list.md)を設定します。 |
