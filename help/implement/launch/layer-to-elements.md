...
1. 「**[!UICONTROL 拡張機能]**」ドロップダウンリストから「**[!UICONTROL コア]**」を選択します。
1. 「**[!UICONTROL データ要素タイプ]**」ドロップダウンリストで、「**[!UICONTROL JavaScript変数]**」を選択します。 右側にテキストフィールドが表示され、このデータ要素にマッピングする JavaScript 変数を入力できます。
