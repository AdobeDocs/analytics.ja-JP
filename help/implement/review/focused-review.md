...
description: 以下の手順に従って、実装をエラーのない状態に保ち、KPI に沿った状態を維持してください。
...
最新のサイトリリースが、そのセクションのデータ収集に悪影響を与えていないことを確認します。そのセクションに対応するコードと変数をすべてレビューし、新しいトラッキングが設計どおりに動作していることを確認します。
...
デモ動画については、![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [実装のレビュー](https://video.tv.adobe.com/v/328340?quality=12&learn=on){target="_blank"}を参照してください。
