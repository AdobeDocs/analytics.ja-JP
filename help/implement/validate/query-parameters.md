...
| --- | --- | --- |
| `aamlh` | なし | Audience Managerの場所のヒント。 CX Enterprise Shared Profile統合で使用されます。 |
| `aamb` | なし | Audience Manager blob. CX Enterprise Shared Profile統合で使用されます。 |
