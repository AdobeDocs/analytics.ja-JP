...
| `pe` | [`linkType`](../vars/config-vars/linktype.md) | カスタムリンクのタイプを決定します。[カスタムリンク](/help/components/dimensions/custom-link.md)、[ダウンロードリンク](/help/components/dimensions/download-link.md)、[離脱リンク](/help/components/dimensions/exit-link.md)に必須です。 |
