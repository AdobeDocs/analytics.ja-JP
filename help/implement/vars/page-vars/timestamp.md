...
`s.timestamp` 変数は、ヒットの日時を含む文字列です。 有効なタイムスタンプ形式は、[ISO 8601](https://datatracker.ietf.org/doc/html/rfc3339#section-5.6)と[Unix time](https://ja.wikipedia.org/wiki/UNIX時間)です（秒単位）。
...
[ISO 8601](https://datatracker.ietf.org/doc/html/rfc3339#section-5.6) で表される日付と時間は、様々な形式を取ることができます。 アドビは、ISO 8601 のすべての機能をサポートしているわけではありません。
